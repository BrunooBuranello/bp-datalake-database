...
DROP PROCEDURE IF EXISTS sp_silver_z17_access_keys_rebuild_full;

DELIMITER $$

CREATE PROCEDURE sp_silver_z17_access_keys_rebuild_full()
BEGIN

    /*
    ============================================================
    PROCEDURE
        sp_silver_z17_access_keys_rebuild_full
