...
BEGIN
    ...
    */
    ...
    /*
    =========================================================
    3. CARREGA BRONZE -> SILVER
    =========================================================
    */

    CALL bp_datalake.sp_load_silver_zsdbil17_faturamento();


    /*
    =========================================================
    4. CARREGA SILVER -> GOLD
    =========================================================
    */

    CALL bp_datalake.sp_load_gold_zsdbil17_faturamento();
    ...
    */
    ...
    CALL bp_datalake.sp_enrich_gold_zsdbil17_faturamento();
